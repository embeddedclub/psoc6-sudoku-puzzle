...
static void process_touch(void)
{
    ...
    static  gui_capsense_data_t gui_capsense_data = {0};
    bool send_ble_command = false;
     /* Total capsense button in the kit */
    gui_capsense_data.buttoncount = CAPSENSE_BUTTON_COUNT;
    ...
    {
        gui_capsense_data.buttonstatus1 = 1u;
    ...
    {
        gui_capsense_data.buttonstatus1 = 2u;
        send_ble_command = true;
    }
    ...
    if((0u != slider_touched) && (slider_pos_perv != slider_pos ))
    {
        ...
        gui_capsense_data.sliderdata = slider_value;
        send_ble_command = true;
        gui_capsense_data.buttonstatus1 = 0;
        gui_capsense_data.buttonstatus2 = 1;
    }

    /* Send command to update LED state if required */
    if(send_ble_command)
    {
        xQueueSendToBack(gui_capsense_data_q, &gui_capsense_data, 0u);
    }



    /* Notify the gui task about the temperature value change. */
    // xTaskNotify(gui_task_handle, 1, eSetValueWithoutOverwrite);
